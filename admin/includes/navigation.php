<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_SESSION['user_fname']." ".$_SESSION['user_lname']?> <b class="caret"></b></a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="profile.php?user_id=<?php echo $_SESSION['user_id']?>"><i class="fa fa-fw fa-dashboard"></i> Profiles</a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
